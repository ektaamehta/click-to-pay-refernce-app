...
public class Payload {
  ...
  private SrcTokenResultsDataObject srcTokenResultsData;
  ...
  **/
  ...
  public Payload srcTokenResultsData(SrcTokenResultsDataObject srcTokenResultsData) {
  ...
  **/
  @jakarta.annotation.Nullable
  public SrcTokenResultsDataObject getSrcTokenResultsData() {
    return srcTokenResultsData;
  }

  public void setSrcTokenResultsData(SrcTokenResultsDataObject srcTokenResultsData) {
    this.srcTokenResultsData = srcTokenResultsData;
  }
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(card, token, shippingAddress, consumerEmailAddress, consumerFirstName, consumerLastName, consumerFullName, consumerMobileNumber, srcTokenResultsData, dynamicData, billingAddress, additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if (jsonObj.get("srcTokenResultsData") != null && !jsonObj.get("srcTokenResultsData").isJsonNull()) {
        SrcTokenResultsDataObject.validateJsonElement(jsonObj.get("srcTokenResultsData"));
      }
