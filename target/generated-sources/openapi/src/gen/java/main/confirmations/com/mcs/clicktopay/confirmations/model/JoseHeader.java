...
public class JoseHeader {
  ...
  **/
  ...
  public JoseHeader kid(String kid) {
   ...
   /**
   * kid - Key indicator to public key used for signature verification.
   * @return kid
  **/
  @jakarta.annotation.Nonnull
  ...
  public JoseHeader jti(String jti) {
   ...
   /**
   * jti - Unique Identified Generated by SRC for this JWS Payload (Mostly a UUID formated string).
   * @return jti
  **/
  ...
  public JoseHeader iat(String iat) {
   ...
   /**
   * iat - Time in UTC epoch format at which the JWS was generated and issued to the requestor.
   * @return iat
  **/
  @jakarta.annotation.Nullable
  ...
  @Override
  public int hashCode() {
    return Objects.hash(alg, kid, jti, iat, additionalProperties);
  }
  ...
  */
  public static void validateJsonElement(JsonElement jsonElement) throws IOException {
      ...
      if ((jsonObj.get("iat") != null && !jsonObj.get("iat").isJsonNull()) && !jsonObj.get("iat").isJsonPrimitive()) {
