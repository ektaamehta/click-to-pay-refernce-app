...
public class CheckoutRequest {
  ...
  **/
  ...
  public CheckoutRequest srcDpaId(String srcDpaId) {
   ...
   /**
   * DPA Identifier provided during onboarding. Registered identifier for the DPA accessing the service. Must be provided except when the calling client is an SRC-PI
   * @return srcDpaId
  **/
  @jakarta.annotation.Nonnull
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(srcClientId, srcDpaId, srcCorrelationId, srcDigitalCardId, additionalProperties);
  }
