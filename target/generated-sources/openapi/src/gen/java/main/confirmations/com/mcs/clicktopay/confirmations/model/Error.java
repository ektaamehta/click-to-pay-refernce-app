...
import com.mcs.clicktopay.confirmations.model.ErrorErrordetailInner;
...
public class Error {
  ...
  private List<ErrorErrordetailInner> errordetail;
  ...
  **/
  ...
  public Error reason(ReasonEnum reason) {
    this.reason = reason;
    return this;
  }
  ...
  **/
  ...
  public Error errordetail(List<ErrorErrordetailInner> errordetail) {
    this.errordetail = errordetail;
    return this;
  }

  public Error addErrordetailItem(ErrorErrordetailInner errordetailItem) {
  ...
  **/
  @jakarta.annotation.Nullable
  public List<ErrorErrordetailInner> getErrordetail() {
    return errordetail;
  }

  public void setErrordetail(List<ErrorErrordetailInner> errordetail) {
    this.errordetail = errordetail;
  }
      ...
      if (jsonObj.get("errordetail") != null && !jsonObj.get("errordetail").isJsonNull()) {
        ...
        if (jsonArrayerrordetail != null) {
          ...
          for (int i = 0; i < jsonArrayerrordetail.size(); i++) {
            ErrorErrordetailInner.validateJsonElement(jsonArrayerrordetail.get(i));
          };
        }
      }
  }
