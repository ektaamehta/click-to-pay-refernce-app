...
import com.mcs.clicktopay.confirmations.model.ComplianceSettings;
import com.mcs.clicktopay.confirmations.model.MaskedConsumerIdentity;
...
public class MaskedConsumer {
  ...
  **/
  ...
  public MaskedConsumer status(String status) {
    this.status = status;
    return this;
  }
  ...
  **/
  ...
  public MaskedConsumer dateConsumerAdded(String dateConsumerAdded) {
   ...
   /**
   * Date (in UTC) consumer was added to the Click to Pay System.
  ...
  **/
  ...
  public MaskedConsumer dateConsumerLastUsed(String dateConsumerLastUsed) {
   ...
   /**
   * Date (in UTC) consumer last transacted in the Click to Pay System.
