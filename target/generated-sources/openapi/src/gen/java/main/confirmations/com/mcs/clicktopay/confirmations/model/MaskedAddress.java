...
public class MaskedAddress {
  ...
  public MaskedAddress addressId(String addressId) {
  ...
  **/
  ...
  public MaskedAddress name(String name) {
   ...
   /**
   * Name of the individual receiving the delivered goods or service. Only applicable for the shipping address. Conditionality-   If known to the Click to Pay System then must be supplied for that address. 
   * @return name
  **/
  ...
  **/
  ...
  public MaskedAddress country(String country) {
  ...
  **/
  ...
  public MaskedAddress zip(String zip) {
   ...
   /**
   * The postal code (for example, zipcode in the U.S.)
   * @return zip
  **/
  @jakarta.annotation.Nullable
  ...
  **/
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.addressId, maskedAddress.addressId) &&
        ...
        Objects.equals(this.country, maskedAddress.country) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(addressId, name, line1, line2, line3, city, state, country, countryCode, zip, createTime, lastUsedTime, additionalProperties);
  }
