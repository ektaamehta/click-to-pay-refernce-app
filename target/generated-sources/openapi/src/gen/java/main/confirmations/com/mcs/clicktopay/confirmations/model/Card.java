...
public class Card {
  ...
  **/
  ...
  public Card paymentAccountReference(String paymentAccountReference) {
   ...
   /**
   * Payment Account Reference. A non-financial reference assigned to each unique PAN and used to link a Payment Account represented by that PAN to affiliated Payment Token.
