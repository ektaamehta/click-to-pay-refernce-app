...
import com.mcs.clicktopay.checkout.model.VerificationType;
...
public class VerificationData {
  ...
  **/
  ...
  public VerificationData verificationMethod(String verificationMethod) {
   ...
   /**
   * &lt;p&gt;Cardholder verification method. Supported values are as follows:&lt;/p&gt;   &lt;ul&gt;     &lt;li&gt;\&quot;01\&quot; - 3D Secure (3DS)&lt;/li&gt;     &lt;li&gt;\&quot;04\&quot; - A shared secret between the Card Issuer and the Cardholder such as One Time Passcode (OTP), activation code&lt;/li&gt;     &lt;li&gt;\&quot;07\&quot; - FIDO2 authentication&lt;/li&gt;     &lt;li&gt;\&quot;24\&quot; - Mastercard authentication with device binding and passive authentication&lt;/li&gt;   &lt;ul&gt;
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(verificationType, verificationEntity, verificationMethod, verificationResults, verificationEvents, additionalProperties);
  }
